            ...
            >
              ...
              >
                <div className="flex items-start justify-between">
                  ...
                  <span className="font-body text-xs text-muted-foreground bg-muted px-2 py-1 rounded-lg shrink-0 ml-2">
                    {m.date}
                  </span>
                </div>
                {m.completed && (
                  <p className="font-handwritten text-cinnabar text-sm mt-2">✓ Đã hoàn thành!</p>
                )}
              </motion.div>
            </motion.div>
          ))}
...
export default MilestoneTimelineReadOnly;
